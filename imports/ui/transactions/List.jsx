      ...
      if (this.props.transactions.length > 0) {
        this.setState({
          txs: this.props.transactions.map((tx, i) => {
            return <TransactionRow key={i} index={i} tx={tx} />;
          }),
        });
      }
    }
        ...
        <div className="">
          <div className="pa1">
            <Row className="header text-nowrap d-none d-lg-flex ">
              <Col xs={9} lg={this.state.homepage ? 5 : 7}>
                <MdMessage className="fs125" />
                &nbsp;
              ...
              >
                <span className={this.state.homepage ? "ml-5" : null}>
              ...
              <Col xs={2} md={1} className="text-nowrap">
                <span className={this.state.homepage ? "ml-4" : null}>
                  <FaCheckCircle />
                  &nbsp;
