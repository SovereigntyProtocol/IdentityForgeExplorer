...
export default class ChainStates extends Component {
    ...
    render() {
        ...
        <>
          <div className="dg gtc4 tac">
            <div className="">
              ...
              <div className="display-4 value text-primary">${0.15}</div>
            </div>
            <div className="">
              <div className="fs125 fw600 card-title">
                <T>chainStates.marketCap</T>
              </div>
              <div className="display-4 value text-primary">{0}</div>
            </div>
            <div className="">
              <div className="fs125 fw600 card-title">
            ...
            <div className="">
              ...
              <div className="display-4 value text-primary">
                {this.renderValues(this.state.communityPool) || 0}
              </div>
            </div>
          </div>
        </>
      ...
      //             <Col xs={4} md="auto"><small><span><T>chainStates.price</T>:</span> <strong>${0.15}</strong></small></Col>
      //             {/* <Col xs={8} md="auto"><small><span><T>chainStates.marketCap</T>:</span> <strong>{this.state.marketCap}</strong></small></Col> */}
      //             <Col xs={8} md="auto"><small><span><T>chainStates.marketCap</T>:</span> <strong>{0}</strong></small></Col>
