      ...
      if (this.props.statusExist && this.props.status.prevotes) {
        return (
          <Row className="status text-center">
            <Col lg={3} md={6}>
              <div>
                <CardTitle className="fs125 fw600">
            ...
            <Col lg={3} md={6}>
              <div>
                {/* <UncontrolledDropdown size="sm" className="more">
                  ...
                  <DropdownMenu>
                    <DropdownItem
                      onClick={(e) => this.handleSwitchBlockTime("", e)}
                    >
                      <T>chainStatus.allTime</T>
                    </DropdownItem>
                    {this.props.status.lastMinuteBlockTime ? (
                      <DropdownItem
                        onClick={(e) => this.handleSwitchBlockTime("m", e)}
                      >
                    ...
                    {this.props.status.lastHourBlockTime ? (
                      <DropdownItem
                        onClick={(e) => this.handleSwitchBlockTime("h", e)}
                      >
                    ...
                    {this.props.status.lastDayBlockTime ? (
                      <DropdownItem
                        onClick={(e) => this.handleSwitchBlockTime("d", e)}
                      >
            ...
            <Col lg={3} md={6}>
              <div>
                ...
                <CardText>
                  ...
                  <T totalValidators={this.state.totalNumValidators}>
                    chainStatus.outOfValidators
                  </T>
                </CardText>
              </div>
            </Col>
            <Col lg={3} md={6}>
              <div>
                {/* <UncontrolledDropdown size="sm" className="more">
                  ...
                  <DropdownMenu>
                    <DropdownItem
                      onClick={(e) => this.handleSwitchVotingPower("", e)}
                    >
                      <T>chainStatus.now</T>
                    </DropdownItem>
                    {this.props.status.lastHourVotingPower ? (
                      <DropdownItem
                        onClick={(e) => this.handleSwitchVotingPower("h", e)}
                      >
                        <T>chainStatus.lastHour</T>
                      </DropdownItem>
                    ) : (
                    ...
                    {this.props.status.lastDayVotingPower ? (
                      <DropdownItem
                        onClick={(e) => this.handleSwitchVotingPower("d", e)}
                      >
                        <T>chainStatus.lastDay</T>
                      </DropdownItem>
                    ) : (
                ...
                <CardText>
                  ...
                  <T
                    percent={numbro(
                      this.state.bondedTokens / this.state.totalSupply
                    ).format("0.00%")}
                    totalStakes={numbro(
                      this.state.totalSupply / Coin.StakingCoin.fraction
                    ).format("0.00a")}
                    denom={Coin.StakingCoin.displayName}
                    denomPlural={Coin.StakingCoin.displayName}
                  >
                    chainStatus.fromTotalStakes
                  </T>
                </CardText>
              </div>
            </Col>
